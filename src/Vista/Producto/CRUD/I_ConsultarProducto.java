 ...
 * @author HACK
 */
public class I_ConsultarProducto extends javax.swing.JPanel {

    IConsultarP cp = new CProducto();
     ...
     */
    public I_ConsultarProducto() {
        initComponents();
        this.addComponentListener(new ComponentAdapter() {
            @Override
            public void componentShown(ComponentEvent e) {
                if (!cp.isEmpty(txtID)) buscar();
            }
        });
    }
    ...
    private void buscar(){
        ...
        if (mp != null) {
            cp.clearCamposConsultarP(this);
            cp.asignarCamposAFormConsultarP(this, mp);
        }
    }
