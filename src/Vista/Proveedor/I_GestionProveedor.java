 ...
 * @author HACK
 */
public class I_GestionProveedor extends javax.swing.JPanel {

    I_AgregarProveedor agregar = new I_AgregarProveedor();
    I_ListarProveedor listar = null;
    I_DesvincularProveedor desvincular = new I_DesvincularProveedor();
    I_ModificarProveedor modificar = new I_ModificarProveedor();
    I_ConsultarProveedor consultar = new I_ConsultarProveedor();
    
    /**
     * Creates new form I_PrincipalGestionCliente
     */
    public I_GestionProveedor() {
        initComponents();
    }
